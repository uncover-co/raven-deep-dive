...
class Raven(_BaseRaven):
    def __init__(
        ...
        baseline_control_variables=None,
        ...
        efficiency_scaler=None,
        investment_column_map=None,
        lift_tests=None,
        extra_effects=None,
        ...
        super().__init__(
            ...
            baseline_control_variables=baseline_control_variables,
            ...
            efficiency_scaler=efficiency_scaler,
            investment_column_map=investment_column_map,
